...
- How to use your data (in combination with open data) to answer these questions
...
- And you will learn a little bit of statistics and some basic programming skills, 

    - but more importantly, you will know how to apply both to real-world problems in academia, business and society.
...
And I would appreciate another chance to guide you through them:

.big[[kutt.it/washdata-zoom](https://kutt.it/washdata-zoom)]
...
- E-Mail: [kutt.it/cowash-gf](https://kutt.it/cowash-gf) (please leave your contact details here)
...
- Feedback form (anonymous and max 5 minutes)
- Certficate for participation? Please add contact details

.big[[kutt.it/cowash-gf](https://kutt.it/cowash-gf)]
...
These slides live on: https://kutt.it/cowash2021