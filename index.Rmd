...
Can't make it? [Click here](https://kutt.it/washdata-zoom) to sign up for another round on 28th April 2021.
...
1. Registered for Colorado WASH Symposium 2021 ([register here](https://wash21.paperform.co/)) 
2. Created a free account on RStudio Cloud ([create one here](https://rstudio.cloud/plans/free))
3. One of Mozilla Firefox, Safari, Google Chrome, Microsoft Edge (just **not** the Internet Explorer)
4. Read the [Code of Conduct](https://larnsce.github.io/co-wash-symposium-2021/code_of_conduct.html) for this workshop
